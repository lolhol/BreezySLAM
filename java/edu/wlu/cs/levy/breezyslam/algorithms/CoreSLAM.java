...
/**
 * CoreSLAM is an abstract class that uses the classes Position, Map, Scan, and
 * Laser
...
public abstract class CoreSLAM {
    ...
    /**
     * Updates the scan, and calls the the implementing class's
     * updateMapAndPointcloud method with zero poseChange
     * (no odometry).
     * 
     * @param scan_mm Lidar scan values, whose count is specified in the
     *                <tt>scan_size</tt>
     *                attribute of the Laser object passed to the CoreSlam
     *                constructor
     */
